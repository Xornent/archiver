...
namespace Archiver.Library
{
    ...
    /// <summary>
    /// Compression method enumeration. Some methods are applicable to selected formats only.
    /// </summary>
    public enum CompressionMethod
    {
        ...
        BZip2,
        /// <summary>
        /// LZMA method based on Lempel-Ziv algorithm, it is default for 7-zip.
        /// </summary>
        Lzma,
        /// <summary>
        /// LZMA version 2, LZMA with improved multithreading and usually slight archive size decrease.
        /// </summary>
        Lzma2,
        /// <summary>
        /// PPMd method based on Dmitry Shkarin's PPMdH source code, very efficient for compressing texts.
        /// </summary>
    ...
    public static class Formats
    {
        ...
        static Formats()
        {
            InSignatureFormatsReversed = 
                new Dictionary<InArchiveFormat, string>(InSignatureFormats.Count);
